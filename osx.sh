...
sudo scutil --set ComputerName "Jessicas-Macbook-Pro"
sudo scutil --set HostName "Jessicas-Macbook-Pro"
sudo scutil --set LocalHostName "Jessicas-Macbook-Pro"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "Jessicas-Macbook-Pro"
